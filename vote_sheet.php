...
<button class="btn-block btn-primary" id="start-voice-vote">Start Voice Voting</button>

<script>
	
	$('#start-voice-vote').click(function() {
            ...
            function processVoiceVote(command) {
                // Match the command with a candidate
                let candidateMatched = false;
				
				
                $('.candidate').each(function() {
					console.log($(this).find('.item .text-center large').text().toLowerCase());
					const candidateName = $(this).find('.item .text-center large').text().toLowerCase();                    if (command.includes(candidateName)) {
