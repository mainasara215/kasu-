...
<body>
  ...
  <main id="main" class=" alert-info" style="background-image: kasuCover.jpg">
  		<div id="login-left">
  			<div class="logo">
  		...
  		<div id="login-right" class="bg-warning">
  			<div class="card col-md-8">
  				<div class="card-body">
					...
					<center><a href="register.php"><button class="btn-sm btn-block btn-wave col-md-4 btn-primary">Register</button></a></center>
